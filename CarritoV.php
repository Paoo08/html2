...
<body style="background-color: #F8FCFD">
    ...
    <a href="Compra.php?id=<?php echo $producto['id']; ?>"><button type="button" class="buttonC">Comprar</button></a>
    </div>
    <p class="nameProducto">CARRITO</p>
    ...
    <div class="producto">
        <div class="seccionesProductos1"> 
            ...
            <div class="arreglo">
                ...
                <br>
                <p class="info">Cantidad: <?php echo $producto['cont']; ?></p>
                <br>
                <div>
                <a href="Eliminar_carrito.php?tipo=1&id=<?php echo $producto['id']; ?>"><button type="button" class="buttonC">+</button></a>
                <a href="Eliminar_carrito.php?tipo=0&id=<?php echo $producto['id']; ?>"><button type="button" class="buttonC">-</button></a>
                </div>
            </div>
        <?php endforeach; ?>
        </div>
